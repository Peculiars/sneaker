...
const LikelyProducts = ()=>{
    ...
    return (
        <section className='mt-14'>
            <div className='max-w-screen-xl h-full flex justify-between w-full'>
            <h2 className="uppercase font-[700] font-archivo text-[24px] text-[#2E2E2E] xs:text-center md:text-left xs:w-full">you might also like</h2>
            ...
            <div className="w-full overflow-x-hidden py-[1%] xs:mr-[12px] md:mr-[0px]">
                {carouselFragment}
            </div>
        </section>
    )
