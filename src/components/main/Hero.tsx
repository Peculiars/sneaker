        ...
        <section className="px-[64px] py-[19px] max-w-screen-xl h-full bg-[#1A1A1A] grid grid-cols-3">
            <div className=" col-span-2 w-full h-full">
                    <div className='mt-12'>
                        ...
                        <Link href='/productList' className='border rounded-[100px] px-3 py-1 text-gray-300 hover:bg-gray-300 hover:text-black hover:transition-opacity duration-500'>Our Collections</Link>
                    </div>
            </div>
